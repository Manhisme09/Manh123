...
public class XoaNhanSu extends javax.swing.JFrame {
    ...
    /**
     * Creates new form XoaNhanSu
     */
    public XoaNhanSu() {
        initComponents();
        ToanCuc tc = new ToanCuc();
        txt_idDelete.setText(String.valueOf(tc.getId()));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(47, 47, 47)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_idDelete, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int result = JOptionPane.showConfirmDialog(frame,
                        ...
                        JOptionPane.QUESTION_MESSAGE);
                if(result == JOptionPane.YES_OPTION){
                    if(CanBoController.deletePerson(Integer.parseInt(txt_idDelete.getText())) == true){
                        this.setVisible(false);
                        new MainForm().setVisible(true); 
                    }else{
                        JOptionPane.showMessageDialog(rootPane,"ID không tồn tại");
                    }
                }        
